...
import time
import numpy as np
from .import modelGoogleMIP, modelGoogleCP, modelCplexMIP, modelCplexCP, datareading
...
def main(computational_time,benchmark,problemType,modelType,Solver,NThreads,address,output):
    ...
    instance = datareading.dataentry('{}/{}'.format(address,benchmark),problemType) #The OpenStack does not allow subdirectories for instances
